...
// try {
// CredenciaisDTO creds = new ObjectMapper().readValue(request.getInputStream(),
// CredenciaisDTO.class);
// UsernamePasswordAuthenticationToken authToken = new
// UsernamePasswordAuthenticationToken(creds.getLogin(), creds.getSenha(), new
// ArrayList<>());
...
// + "\"error\": \"Não autorizado\", " + "\"message\": \"Email ou senha
// inválidos\", "
// + "\"path\": \"/login\"}";
// }
...
// "\"profile\": " + usuario.getPerfis().stream().map(x -> "\"" + x +
